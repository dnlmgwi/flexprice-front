...
function renderEventCountPortal(row: UsageAnalyticItem) {
										...
										bucket.items.map((row, childIndex) => {
											...
											return (
												<TableRow
													...
													<TableCell className='py-2.5 font-normal text-gray-600 text-[13px]'>{renderEventCountPortal(row)}</TableCell>
